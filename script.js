...
const displayAllPost = (posts) =>{
   ...
   posts.forEach(post => {
    ...
    div.innerHTML = `
       <div class="p-6 lg:p-12 flex gap-5 lg:flex-row flex-col items-center lg:items-start bg-[#F3F3F5] rounded-3xl">
          <div class="indicator">
...
div.innerHTML = `
 <div class="flex justify-between p-2 lg:p-3 bg-white rounded-2xl items-center gap-3">
                ...
                <div class="lg:w-1/5 w-4/12 flex justify-end">
                  <p><i class="fa-regular"></i> ${view_count}</p>
                </div>
              </div>
`
